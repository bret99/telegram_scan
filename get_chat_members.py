...
def Chat_members():
    ...
    try:
        with app:
            ...
            for member in app.get_chat_members(chat_members):
                members = 'ID: {}'.format(member.user.id), 'first_name: {}'.format(member.user.first_name), 'last_name: {}'.format(member.user.last_name), 'username: {}'.format(member.user.username), 'phone number: {}'.format(member.user.phone_number)
            ...
            for member in app.get_chat_members(chat_members, filter=enums.ChatMembersFilter.ADMINISTRATORS):
                administrators = 'ID: {}'.format(member.user.id), 'first_name: {}'.format(member.user.first_name), 'last_name: {}'.format(member.user.last_name), 'username: {}'.format(member.user.username), 'phone number: {}'.format(member.user.phone_number)
                print('\033[1;96mid\033[1;00m:', member.user.id, '\033[1;96mfirst name\033[1;00m:', member.user.first_name, '\033[1;96mlast name\033[1;00m:', member.user.last_name, '\033[1;96musername\033[1;00m:', member.user.username, '\033[1;96mphone number\033[1;00m:', member.user.phone_number)
            ...
            for member in app.get_chat_members(chat_members, filter=enums.ChatMembersFilter.BOTS):
                bots = 'ID: {}'.format(member.user.id), 'first_name: {}'.format(member.user.first_name), 'last_name: {}'.format(member.user.last_name), 'username: {}'.format(member.user.username), 'phone number: {}'.format(member.user.phone_number)
                print('\033[1;96mid\033[1;00m:', member.user.id, '\033[1;96mfirst name\033[1;00m:', member.user.first_name, '\033[1;96mlast name\033[1;00m:', member.user.last_name, '\033[1;96musername\033[1;00m:', member.user.username, '\033[1;96mphone number\033[1;00m:', member.user.phone_number)
